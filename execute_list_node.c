...
void execute_list_node(execution_list** current_node_ptr,
		       execution_list** last_node_ptr) {
  execution_list* current_node = *current_node_ptr;
  execution_list* last_node = *last_node_ptr;
